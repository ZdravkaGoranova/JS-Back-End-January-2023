...
const db = require('./db.json');//require парсва json файла и го прави в JS object
const secret = 'myveryverysecretsecret'

async function sabeDb() {
...
exports.loginUser = async (username, password) => {
    ...
    const token = jwt.sign(payload, secret, options);//ще генерира синхронно token
